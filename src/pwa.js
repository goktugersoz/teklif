  ...
  sheet.innerHTML = `
    ...
    <section class="install-sheet__panel" role="dialog" aria-modal="true" aria-labelledby="installSheetTitle">
      ...
      <div class="install-sheet__app">
        <img class="install-sheet__logo" src="./fiyatladim-logo-v5.png" alt="Fiyatladim." onerror="this.onerror=null;this.src='./icon-192-v5.png';this.classList.add('install-sheet__logo--icon')">
        <div>
